                        ...
                        <div className="tu-tutorprofilewrapp">
                                    ...
                                    <div className="tu-protutordetail">
                                        <div className="tu-productorder-content">
                                            ...
                                            <div className="tu-product-title">
                                                <h3>Armando weber <i className="icon icon-check-circle tu-greenclr" data-tippy-trigger="mouseenter" data-tippy-html="#tu-verifed" data-tippy-interactive="true" data-tippy-placement="top"></i></h3>
                                                <h5>Spreading knowledge everywhere that's all I do</h5>
                                            </div>
                                        ...
                                        <ul className="tu-tutorreview">
                                            ...
                                            <li>
                                                <span><i className="icon icon-map-pin"><span>Sacramento, CA</span></i></span>
                                            </li>
                                        </ul>
                                        <div className="tu-detailitem">
                                            ...
                                            <div className="tu-languagelist">
                                                <ul className="tu-languages">
                                                    ...
                                                    <li>French</li>
                                                    <li>Spanish</li>
                                                    <li><a className="tu-showmore tu-tippytooltip" href="javascript:void(0);" data-tippy-trigger="click" data-tippy-html="#tu-industrypro" data-tippy-interactive="true">+02 more</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="tu-actionbts">
                                <div className="tu-userurl">
                                    ...
                                    <a href="javascript:void(0);">www.tutorlinkhere.com/tutor/uk/armando/295548 <i className="icon icon-copy"></i></a>
                                </div>
                                        ...
                                        <ul className="tu-icanteach">  
                                            <li>
                                                ...
                                                <ul className="tu-serviceslist">
                                                    ...
                                                    <li>
                                                        <a href="search-listing.html">Engineering - Comupter</a>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="search-listing.html">Computer langugages</a>
                                                    </li>
                                                    <li>
                                            ...
                                            <li>
                                                ...
                                                <ul className="tu-serviceslist">
                                                    <li>
                                                        <a href="search-listing.html">Physical education</a>
                                                    </li>
                                                    <li>
                                                        <a href="search-listing.html">Computer Science</a>
                                                    </li>
                                            ...
                                            <li>
                                                ...
                                                <ul className="tu-serviceslist">
                                                    ...
                                                    <li>
                                                        <a href="search-listing.html">MFC (old framework-legacy)</a>
                                                    </li>
                                                    <li>
