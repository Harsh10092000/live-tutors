...
const Filters = ({ filters, onFilterChange }) => {
  ...
  const tutoringTypes = [
    ...
    { value: "Travel to tutor", label: "Travel to Tutor" }
  ];
  ...
  const handleTutoringTypeChange = (value) => {
    const currentTypes = filters.tutoring_type ? filters.tutoring_type.split(',') : [];
    let newTypes;
    ...
    onFilterChange('tutoring_type', newTypes.join(','));
  };

  // Handle multiple selection for languages
  const handleLanguageChange = (value) => {
    const currentLanguages = filters.language ? filters.language.split(',') : [];
    let newLanguages;
    ...
    onFilterChange('language', newLanguages.join(','));
  };
                    ...
                    <li key={index}>
                      <div className="tu-check">
                        <input
                          type="checkbox"
                          id={`type_${index}`}
                          checked={filters.tutoring_type?.split(',').some(t => t === type.value)}
                    ...
                    <li key={index}>
                      <div className="tu-check">
                        <input
                          type="checkbox"
                          id={`lang_${index}`}
                          checked={filters.language?.split(',').some(l => l === lang)}
